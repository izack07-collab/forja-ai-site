...
const pilares = [
  {
    ...
    features: [
      ...
      "Feita pro celular (80% das suas clientes compram por ele)",
  ...
  },
  {
    ...
    desc: "Consultor virtual treinado com seu catálogo real, sua voz de marca. Atende 24/7, encaminha pro checkout e ainda vai atrás de quem não fechou: recupera carrinho abandonado e faz follow-up sozinho.",
    features: [
